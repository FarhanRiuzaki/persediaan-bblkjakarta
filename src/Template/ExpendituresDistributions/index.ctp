        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Kode", 
                        "name": "ExpendituresDistributions.code", 
                        "targets": 1,
                        "data" : 'code'
                    },
                    { 
                    ...
                    { 
                        ...
                        "targets": 3,
                        "data" : 'internal_order.code'
                    },
                    { 
                        "title": "Tanggal", 
                        "name": "ExpendituresDistributions.date", 
                        "targets": 4,
                        "data" : 'date',
                    ...
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "ExpendituresDistributions.created",
                        "searchable": !1,  
                        "targets": 5,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "ExpendituresDistributions.modified",
                        "searchable": !1,  
                        "targets": 6,
                        "data" : 'modified',
                        width:'15%',
