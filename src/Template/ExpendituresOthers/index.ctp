        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Kode", 
                        "name": "ExpendituresOthers.code", 
                        "targets": 1,
                        "data" : 'code'
                    },
                    { 
                        "title": "Diberikan Kepada", 
                        "name": "ExpendituresOthers.given_to", 
                        "targets": 2,
                        "data" : 'given_to'
                    },
                    { 
                        "title": "Tanggal", 
                        "name": "ExpendituresOthers.date", 
                        "targets": 3,
                        "data" : 'date',
                    ...
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "ExpendituresOthers.created",
                        "searchable": !1,  
                        "targets": 4,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "ExpendituresOthers.modified",
                        "searchable": !1,  
                        "targets": 5,
                        "data" : 'modified',
                        width:'15%',
