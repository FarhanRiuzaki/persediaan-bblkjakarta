            ...
            <div class="kt-portlet__head" id='hide'>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        ...
                        <ul class="kt-nav">
                            ...
                            <li class="kt-nav__item">
                                <a href="<?= $this->Url->build(['action' => 'view', $expendituresOther->id, '?' => ['print' => 'pdf']])  ?>" class="kt-nav__link no-print btn-print " target="_BLANK" data-print="pdf">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($expendituresOther->expenditures_others_details)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="onlyNumber"><?= h($expendituresOtherDetails->price) ?></td>
                                                <td><span class="onlyNumberWithoutSeparator"><?= h($expendituresOtherDetails->qty) ?></span> <?= h($expendituresOtherDetails->product->unit) ?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </tbody>
