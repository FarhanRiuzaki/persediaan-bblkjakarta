            ...
            <div class="kt-portlet__head" id='hide'>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        ...
                        <ul class="kt-nav">
                            ...
                            <li class="kt-nav__item">
                                <a href="<?= $this->Url->build(['action' => 'view', $expendituresReclarification->id, '?' => ['print' => 'pdf']])  ?>" class="kt-nav__link no-print btn-print " target="_BLANK" data-print="pdf">
                ...
                <table class="table table-invoice">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th width="2%">:</th>
                            <th width="18%" ><?=$this->Utilities->indonesiaDateFormat($expendituresReclarification->date->format('Y-m-d'));?></th><th width="18%"></th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($expendituresReclarification->expenditures_reclarifications_details)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="onlyNumberWithoutSeparator"><?= h($expendituresReclarificationDetails->price)?></td>
                                                <td><span class="onlyNumber"><?= h($expendituresReclarificationDetails->qty) ?></span> <?= h($expendituresReclarificationDetails->product->unit)?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    <tbody>
