    ...
    <div class="m-portlet__body">
        ...
        <table class='body' width="100%;" style="font-size: 15px !important;">
            ...
            <tbody>
                <?php 
                    $no = 1;
                    foreach($exportProduct->export_products_details  as $key => $val):
                ?>
                <tr>
                    <td class="text-center"><?= $no++ ?></td>
                    <td style="padding:5px"><?=$val->product->name ;?> </td>
                    <td class="text-center" style="padding:5px"><?=$val->qty  ;?> <?=$val->product->unit ;?></td>
                    <td></td>
                </tr>
                <?php endforeach;?>
        ...
        <table class='footer text-center' width="100%;" style="font-size: 15px !important;">
            <tr>
                <td rowspan="3" width='33%'>Tanggal: <?= date('d-m-Y')?> <br>
                        Yang mengajukan:
