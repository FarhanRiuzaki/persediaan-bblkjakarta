    ...
    <div class="m-portlet__body">
        ...
        <table width="100%;" style="font-size: 15px !important;">
            <tr>
                ...
                <td width='10px'>:</td>
                <td><?= $internalOrder->expenditures_distributions == null ? '-' : $internalOrder->expenditures_distributions[0]->code ?></td>
            </tr>
            <tr>
                <td width='170px'>Bagian/Bidang/Su Bag/Seksi/Instalasi</td>
                <td width='10px'>:</td>
                <td><?= $internalOrder->expenditures_distributions == null ? '-' : $internalOrder->expenditures_distributions[0]->institute->name ?></td>
            </tr>
        </table>
        ...
        <table class='body' width="100%;" style="font-size: 15px !important;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?= $val->qty ?> <?= $val->product->unit ?></td>
                    <td><?= $val->note ?></td>
                </tr>
                <?php endforeach;
                    endif;
        ...
        <table class='footer text-center' width="100%;" style="font-size: 15px !important;">
            <tr>
                <td rowspan="3" width='33%'>Tanggal: <?= $internalOrder->expenditures_distributions == null ? '-' : $internalOrder->expenditures_distributions[0]->date->format('Y-m-d')?> <br>
                        Yang menyerahkan:
            ...
            <tr>
                <td width='33%'>Penerima: Bagian/Bidang/Sub Bidang/Seksi/instalasi</td>
                <td width='33%'>Kepala Bagian Tata Usaha BBLK JKT</td>
            </tr>
            <tr>
