    ...
    <div class="m-portlet__body">
        ...
        <table class='body' width="100%;" style="font-size: 15px !important;">
            ...
            <tbody>
                <?php 
                    $no = 1;
                    foreach($internalOrder->internal_orders_details  as $key => $val):
                ?>
                <tr>
        ...
        <table class='footer text-center' width="100%;" style="font-size: 15px !important;">
            <tr>
                <td rowspan="3" width='33%'>Tanggal: <?= $internalOrder->date->format('Y-m-d')?> <br>
                        Yang mengajukan:
            ...
            <tr>
                <td width='33%'>Kepala Bagian/Bidang/Sub Bidang/Seksi/instalasi</td>
