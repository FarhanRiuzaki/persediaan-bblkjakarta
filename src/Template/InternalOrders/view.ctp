                        ...
                        <ul class="kt-nav">
                            <li class="kt-nav__item">
                                <a href="<?= $this->Url->build(['action' => 'view', $internalOrder->id, '?' => ['print' => 'pdf']])  ?>" class="kt-nav__link no-print btn-print " target="_BLANK" data-print="pdf">
                                    ...
                                    <span class="kt-nav__link-text">Print Form</span>
                                </a>
                            </li>
                            <li class="kt-nav__item">
    ...
    <div class="kt-portlet__body" id='section-to-print'>
        ...
        <table class="table table-invoice">
            <thead>
                <tr>
                    <th width="40%" colspan="3">
                        <?php if($internalOrder->status == 4 && ($userData->user_group_id != 6 && $userData->user_group_id != 4 && $userData->user_group_id != 5)): ?>
                            <span ><a href="#" class="btn btn-info m-btn text-white confirm" data-id='<?= $internalOrder->id?>'>Konfirmasi barang telah diterima</a></span>
                        <?php endif; ?>
                    </th>
                    <th width="10%">&nbsp;</th>
            ...
            <tbody>
                ...
                <tr>
                    <?php if($userData->user_group_id == 6 || $userData->user_group_id == 4): ?>
                        <th width="15%">Tanggal Penyerahan</th>
                        <th width="2%">:</th>
                        <th width="18%"><?=$internalOrder->expenditures_distributions == null ? '-' : $this->Utilities->indonesiaDateFormat($internalOrder->expenditures_distributions[0]->date->format('Y-m-d'))?></th>
                    <?php else: ?>
                        <th width="15%">Tanggal Approval / Waktu Approval</th>
                        <th width="2%">:</th>
                            ...
                            <tbody>
                                ...
                                <?php if (!empty($internalOrder->internal_orders_details)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php $cek = 0; if($internalOrder->status == 3): ?>
                                        ...
                                        <?php else:?>
                                            ...
                                            <?php 
                                            $cek = 0;
                                            if($internalOrder->expenditures_distributions != null):
                                                $no = 1;
                                                foreach($internalOrder->expenditures_distributions[0]->expenditures_distributions_details    as $key => $val):
                                                    if($val->internal_orders_detail_id == $internalOrdersDetails->id ):
                                                        $cek++;
                                            ?>
                                                <td><?= $val->qty ?> <?= h ($internalOrdersDetails->product->unit) ?></td>
                                                <td><?= $val->note ?></td>
                                        ...
                                        <?php if($cek == 0):?>
                                            <td><?= h($internalOrdersDetails->note) ?></td>
                                        <?php endif;?>
                                        ...
                                        ?>
                                        <td><span class="onlyNumberWithoutSeparator">0</span> <?= h($internalOrdersDetails->product->unit) ?></td> -->
