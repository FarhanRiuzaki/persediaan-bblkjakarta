        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Kode", 
                        "name": "ItemHandovers.code", 
                        "targets": 1,
                        "data" : 'code'
                    },
                    { 
                        "title": "Jenis", 
                        "name": "ItemHandovers.category", 
                        "targets": 2,
                        "data" : 'category',
                        render:function(type) {
                            return Utils.categoriesOut(type)
                        }
                    },
                    { 
                        "title": "Diberikan Kepada", 
                        "name": "ItemHandovers.given_to", 
                        "targets": 3,
                        "data" : 'given_to',
                    },
                    { 
                        "title": "Tanggal", 
                        "name": "ItemHandovers.date", 
                        "targets": 4,
                        "data" : 'date',
