                ...
                <table class="table table-invoice">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th width="2%">:</th>
                            <th width="18%"><?=$this->Utilities->categorieOut()[$record->category];?></th>
                            <th width="18%"></th>
                        
                            <th width="17%">Kode Barang Keluar</th>
                            <th width="2%">:</th>
                            ...
                            <td colspan="15">
                                <table class="table table-bordered table-detail">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($record->item_handovers_details )): ?>
                                            <?php foreach ($record->item_handovers_details  as $val): ?>
                                            <tr>
                                                <td><?= h($no += 1) ?></td>
