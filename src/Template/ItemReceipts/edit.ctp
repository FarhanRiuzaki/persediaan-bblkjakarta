                        ...
                        <div class="kt-section__body">
                            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($record->item_receipts_details as $key => $val):?>
                                    <tr>
                                            <td style='vertical-align: middle' class="number"><?=$key + 1;?></td>
                                            <td style='vertical-align: middle'>
                                                [<?=$val->product->code;?>] <?=$val->product->name;?>
                                            </td>
                                            <td > 
                                                <input type="text" data-name="qty" value="<?=$val->qty;?>" name="item_receipts_details[<?=$key;?>][qty]" class="price form-control onlyNumberWithoutComa">
                                            </td>
                                            <td align='center' style='vertical-align: middle'>
                                                <?=$val->product->unit;?>
                                            </td>
                                            <td>
                                                <input type="text" data-name="price" value="<?=$val->price;?>" name="item_receipts_details[<?=$key;?>][price]" class="price form-control onlyNumber">
                                            </td>
                                            <td>
                                                <input type="text" data-name="expired" value="<?=$val->expired == null ? '' : $val->expired->format('Y-m-d');?>" name="item_receipts_details[<?=$key;?>][expired]" class="form-control datepicker">
                                            </td>
                                            <td class="text-center">
                                                <input type="hidden" data-name="id" value="<?=$val->id;?>" name="item_receipts_details[<?=$key;?>][id]">
                                                <input type="hidden" data-name="product_id" value="<?=$val->product_id;?>" name="item_receipts_details[<?=$key;?>][product_id]">
