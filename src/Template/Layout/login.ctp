...
<html lang="en" >
    ...
    <head>
        ...
        <?php
            ...
            $this->Html->css($cssCustomStyle,['block'=>'cssCustomStyle','pathPrefix' => '/assetsv2/']);
            $this->Html->css($cssThemeStyle,['block'=>'cssThemeStyle','pathPrefix' => '/assetsv2/']);
            $this->Html->css($cssSkinStyle,['block'=>'cssSkinStyle','pathPrefix' => '/assetsv2/']);
            ...
            <div class="kt-grid kt-grid--ver kt-grid--root">
                <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
                    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
                                ...
                                <div class="kt-login__container">
                                    <div class="kt-login__body">
                                        <div class="kt-login__logo">
                                            <a href="#">
                                            <?php $image = $this->Utilities->generateUrlImage(null,$defaultAppSettings['App.Logo.Login']); ?>
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background-image: url('<?=$this->Url->build('/assetsv2/dist/media/bg/bgs.png');?>')">
                            <div class="kt-login__section">
                                <div class="kt-login__block">
                                    <h3 class="kt-login__title" style="font-weight: 1000;"><span><?=$defaultAppSettings['App.Name'];?> </span></h3>
                                    <div class="kt-login__desc" style="font-weight: 600;font-size: 20px">
    ...
    <?php
        ...
        $this->Html->script($jsGlobalTheme,['block'=>'jsGlobalTheme','pathPrefix' => '/assetsv2/']);
        $this->Html->script($jsPage,['block'=>'jsPage','pathPrefix' => '/assetsv2/']);
        $this->Html->script($jsGlobalPage,['block'=>'jsPage','pathPrefix' => '/assetsv2/']);
    ?>
