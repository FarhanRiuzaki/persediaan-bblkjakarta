            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        ...
                        "name": "Institute.name", 
                        "targets": 2,
                        "data" : 'purchase_orders_details',
                        render: function(data, type, row) {
                            console.log(data);
                            if(data[0] != null){
                                if(data[0].purchase_request != null){
                                if(data[0].purchase_request.institute != null){
                                        return data[0].purchase_request.institute.name;
                                }
                                    return '-';
                                }
                                return '-';
