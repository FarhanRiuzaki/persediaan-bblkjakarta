...
?>
    <?php if($this->Acl->check(['action'=>'add']) == true):?>
        <a href="<?=$this->Url->build(['action'=>'add']);?>?type=0" class="btn btn-primary">
            <i class="la la-plus-circle"></i> Tambah Pengajuan
        </a>
    <?php endif;?>
<?php
    $this->end();
        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "PurchaseSubmisions.created",
                        "searchable": !1,  
                        "targets": no++,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "PurchaseSubmisions.modified",
                        "searchable": !1,  
                        "targets": no++,
                        "data" : 'modified',
                        width:'15%',
                    ...
                    { 
                        "title": "Status", 
                        "name": "PurchaseSubmisions.status", 
                        "searchable": !1,  
                        "className": "text-center",
                        "targets": no++,
                        "data" : 'status',
                        render:function(e) {
                            return Utils.statusPP(e)
                        }
                    },
                ],
                "order": [[ 1, "ASC" ]]
