            ...
            <div class="kt-portlet__head" id='hide'>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        ...
                        <ul class="kt-nav">
                            ...
                            <li class="kt-nav__item">
                                <a href="<?= $this->Url->build(['action' => 'view', $receiptGrant->id, '?' => ['print' => 'pdf']])  ?>" class="kt-nav__link no-print btn-print " target="_BLANK" data-print="pdf">
                ...
                <table class="table table-invoice">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th width="2%">:</th>
                            <th width="18%"><?=($receiptGrant->date_bast == null || $receiptGrant->date_bast == '') ? '' : $this->Utilities->indonesiaDateFormat($receiptGrant->date_bast->format('Y-m-d'))?></th>
                            <th width="18%"></th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (!empty($receiptGrant->receipt_grants_details)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="onlyNumberWithoutSeparator"><?= h($ReceiptgrantsDetails->qty) ?></span> <?= h($ReceiptgrantsDetails->product->unit)?></td>
                                                <td class="onlyNumber"><?= h($ReceiptgrantsDetails->price)?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    <tbody>
