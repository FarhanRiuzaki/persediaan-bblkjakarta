        ...
        var validatorPrimary = $(".form-primary").validate({
            rules: {
                date: {
                 ...
                 expenditures_reclarification_id : {
                    required : true
                },
            ...
            messages: {
                ...
                expenditures_reclarification_id: {
                    required: "Harap pilih reklarifikasi pengeluaran"
                },
            ...
            submitHandler: function (form) {
                ...
                if(validateDetail){
                    $(form).ajaxSubmit({
                        ...
                        success : function(result){
                            if(result.code == 200){
                                swal.fire('Berhasil disimpan','Data reklarifikasi masuk berhasil disimpan','success');
