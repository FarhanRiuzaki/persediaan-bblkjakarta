        ...
        jQuery(document).ready(function() {
            ...
            var options = {
                "columnDefs": [
                    ...
                    { 
                        "title": "Kode", 
                        "name": "ReceiptReclarifications.code", 
                        "targets": 1,
                        "data" : 'code'
                    },
                    { 
                        "title": "Kode Reklarifikasi Pengeluaran", 
                        "name": "ExpendituresReclarifications.code", 
                        "targets": 2,
                        "data" : 'receipt_reclarification.code'
                    },
                    { 
                        "title": "Tanggal", 
                        "name": "ReceiptReclarifications.date", 
                        "targets": 3,
                        "data" : 'date',
                    ...
                    { 
                        "title": "Tgl. Dibuat", 
                        "name": "ReceiptReclarifications.created",
                        "searchable": !1,  
                        "targets": 4,
                        "data" : 'created',
                        width:'15%',
                    ...
                    { 
                        "title": "Tgl. Diubah", 
                        "name": "ReceiptReclarifications.modified",
                        "searchable": !1,  
                        "targets": 5,
                        "data" : 'modified',
                        width:'15%',
