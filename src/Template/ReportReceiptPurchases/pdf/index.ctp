...
<table class="table100 ver2 table-secondary">
    <thead>
        ...
        <tr>
            <th width="2%">No.</th>
            <th width="5%">Kode Penerimaan Barang Pembelian</th>
            <th width="5%">Nama barang</th>
            <th width="5%">Jumlah Penerimaan Barang Pembelian</th>
            <th width="5%">Jumlah Pesanan Barang Pembelian</th>
            <th width="5%">Harga Pesanan Barang Pembelian</th>
    ...
    <tbody>
        ...
        <?php foreach ($results as $key => $result):?>
            <?php
                $total_qty_receipt += $result->qty;
                $total_qty += $result->qty1;
                $total_price += $result->price1;
            ...
            <tr>
                ...
                <td class="text-right"><?=$this->Utilities->formatNumber($result->qty1, 5);?> <?=$result->unit;?></td>
                <td class="text-right"><?=$this->Utilities->formatNumber($result->price1) ?></td>
        ...
        <tr>
            ...
            <td class="text-right"><?=$this->Utilities->formatNumber($total_qty_receipt);?></td>
