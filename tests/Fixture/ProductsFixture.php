...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unit' => ['type' => 'string', 'length' => 225, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2019-04-15 07:46:45',
                'created_by' => 1,
                'modified' => '2019-04-15 07:46:45',
                'modified_by' => 1
            ],
        ];
        parent::init();
