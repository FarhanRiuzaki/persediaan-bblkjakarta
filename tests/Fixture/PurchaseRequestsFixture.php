...
class PurchaseRequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'approve_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'approve_by' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-22 09:51:19',
                'created_by' => 1,
                'modified' => '2019-04-22 09:51:19',
                'modified_by' => 1,
                'approve_date' => '2019-04-22 09:51:19',
                'approve_by' => 1
            ],
        ];
        parent::init();
