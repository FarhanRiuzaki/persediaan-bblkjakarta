...
/**
 * ReceiptOthersDetailsFixture
 *
 */
class ReceiptOthersDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'receipt_other_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'qty' => 1.5,
                'price' => 1.5,
                'created' => '2019-04-23 08:16:48',
                'modified' => '2019-04-23 08:16:48'
            ],
        ];
        parent::init();
    }
