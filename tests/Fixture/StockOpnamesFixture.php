 ...
 *
 */
class StockOpnamesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 225, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date' => '2019-04-29',
                'created' => '2019-04-29 04:40:28',
                'modified' => '2019-04-29 04:40:28',
                'created_by' => 1,
                'updated_by' => 1
            ],
        ];
