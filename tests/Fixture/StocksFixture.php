...
class StocksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ref_table' => ['type' => 'string', 'length' => 225, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'price' => ['type' => 'decimal', 'length' => 22, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'qty' => 1,
                'price' => 1.5,
                'created' => '2019-04-26 09:15:39',
                'modified' => '2019-04-26 09:15:39'
            ],
        ];
        parent::init();
    }
