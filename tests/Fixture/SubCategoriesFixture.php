...
class SubCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2019-04-15 06:45:56',
                'created_by' => 1,
                'modified' => '2019-04-15 06:45:56',
                'modified_by' => 1
            ],
        ];
        parent::init();
